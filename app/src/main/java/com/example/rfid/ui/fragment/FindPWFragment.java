...
import com.example.rfid.databinding.FragmentFindPwBinding;
        ...
        binding.findpwBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!binding.inputidEdt.getText().toString().equals("")){
                    ...
                    Toast.makeText(requireContext(),"아이디를 입력해주세요.",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    private void FindPW(){
        apiService.findPassword(binding.inputnameEdt.getText().toString(), Integer.parseInt(binding.inputnumEdt.getText().toString()),
                binding.inputidEdt.getText().toString()).enqueue(new Callback<String>() {
